{
  ...
  outputs =
    ...
    let
      ...
      activationPackages = nixpkgs.lib.mapAttrs (_: configuration: configuration.activationPackage) configurations;
    in
    {
      checks = nixpkgs.lib.mapAttrs (_: activationPackage: { inherit activationPackage; }) activationPackages;
